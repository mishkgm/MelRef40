...
// TEXT FOR FUNC REFACTOR        isUserInteractionEnabled = true
...
// TEXT FOR FUNC REFACTOR        self.alpha = 0.0
...
// TEXT FOR FUNC REFACTOR        self.alpha = 1.0
...
// TEXT FOR FUNC REFACTOR        self.layer.shadowColor = UIColor.black.cgColor
