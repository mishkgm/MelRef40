        ...
        for productIdentifier in productIdentifiers {
            ...
            validateSubscriptionWithCompletionHandler_MWP(productIdentifier: productIdentifier) { isValid in
                ...
                if isValid {
                    ...
                    if productIdentifier == Configurations_MWP.unlockerThreeSubscriptionID {
            ...
            case .purchased:
                if let product = getCurrentProduct_MWP() {
                    if transaction.payment.productIdentifier == product.productIdentifier {
                        ...
                        } else if transaction.payment.productIdentifier == Configurations_MWP.unlockerThreeSubscriptionID {
